...
<section class="site-hero overlay"
	style="background-image: url(images/abstract-gf7802ba87_1920.jpg)"
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
				<h2 class="heading">ì½ëë¦¬ì¤ì ëíì¬ ..</h2>
				<p style="font-size: 18px;">ìì´ë²ë¦° ë´ ì´ì´í°ì ì§ì
					ì°¾ìì£¼ê³  ì¶ë¤ë©´ ì´ì ì´ì©í´ë³´ì¸ì!</p>
				<p>
					<a href="#" class="btn btn-primary text-white py-2 mr-3">ë
						ë³´ê¸°</a>
				</p>
			</div>
