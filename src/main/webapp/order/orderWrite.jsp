...
<body>
	...
	<fieldset>
	<legend>상품 정보</legend>
		상품번호 : <input type="text" name = "id" value="goods_id" readonly ><br>
		상품사진 : <img src="../img/img.jpg " width="100px"><br>
		상품이름 : <input type="text" name = "title" value="title" readonly ><br>
		상품가격 : <input type="text" name = "price" value="price" readonly ><br>
		배송비 여부 : 
	...
	<!--  action주소가 없으면 자신의 페이지 호출 -->
		...
		전화번호 : <input type="text" name = "phNumber" value="010-0000-0000"><br>
